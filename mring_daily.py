...
#建立mgo库连接
engine=create_engine("mysql+pymysql://bi:***@rr-bp18237k924jt6e70bo.mysql.rds.aliyuncs.com:3306/{0}?charset=utf8".format('mgo'))
#查询mgo库方法
def reader(query):
    sql=query
...
#建立mring库连接
engine1=create_engine("mysql+pymysql://bi:***@rr-bp18237k924jt6e70bo.mysql.rds.aliyuncs.com:3306/{0}?charset=utf8".format('mring'))
#查询mring库方法
